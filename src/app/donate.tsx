...
export default function Donate() {
  const { donationForm, setDonationForm, addDonation, recipients } = useDonationContext();
  ...
  const handleDonorChange = (donorId, donorName) => {
          ...
          <View style={styles.container}>
            <View >
              ...
              <View style={styles.inputGroup}>
                ...
                {/* Editable input field for DonorName */}
                <TextInput
